...
class KelasAdmin(admin.ModelAdmin):
    list_display = ('id_kelas', 'nama_kelas', 'guru', 'token')
    search_fields = ('nama_kelas', 'token')
    # PERBAIKAN: 'id_guru' diganti 'guru'
    list_filter = ('guru',)
...
class AnggotaKelasAdmin(admin.ModelAdmin):
    list_display = ('id_anggota', 'kelas', 'siswa')
    # PERBAIKAN: menyesuaikan pencarian relasi
    search_fields = ('kelas__nama_kelas', 'siswa__nama_lengkap')
...
class KuisAdmin(admin.ModelAdmin):
    list_display = ('id_kuis', 'nama_kuis')
...
class PeringkatFinalAdmin(admin.ModelAdmin):
    ...
    search_fields = ('siswa__nama_lengkap', 'siswa__email')
